...
OverlayShader::OverlayShader(Renderer* renderer) : m_Renderer(renderer)
{
}

bool OverlayShader::Create()
{
	if (!CreateVertexShader("OverlayVertexShader.cso"))
		return false;

	if (!CreatePixelShader("OverlayPixelShader.cso"))
		return false;

	return true;
}

void OverlayShader::Use()
{
...
bool OverlayShader::CreateVertexShader(const std::string& vertex_shader_path)
{
...
bool OverlayShader::CreatePixelShader(const std::string& pixel_shader_path)
{
